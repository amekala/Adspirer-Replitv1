 ...
 * 
 * Run with: node test-campaign-flow.mjs
 */
...
async function runTest() {
  try {
    ...
    try {
      ...
      console.log('Campaign creation initiated successfully');
    } catch (error) {
      logError(4, error);
      console.log('Stopping test due to error when initiating campaign creation');
      return;
    }
